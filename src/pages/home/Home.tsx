...
export const Home: React.FC = () => {
    ...
    const carouselList = [
        {
            url: 'https://oss.linklearner.com/homepage/117.png',
            description: '第二期',
        },
        {
            url: 'https://oss.linklearner.com/homepage/banner-2.png',
            description: '科大讯飞活跃竞赛汇总！',
        },
    ];
    ...
    const activityList = [
        {
            title: '网站反馈：问题建议都来提提吧！',
            time: '2023-1-1 截止',
        },
        {
            title: 'Datawhale B站直播间',
            time: '2023-1-1 截止',
        },
    ];
